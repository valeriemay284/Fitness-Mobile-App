...
export default function Dashboard() {
  ...
  return (
    <View style={styles.container}>
      {/* Profile */}
      <Card style={styles.card} onPress={() => router.push("/user_info")}>
      ...
      {/* Workout */}
      <Card style={styles.card} onPress={() => router.push("/workout" as any)}>
        <Card.Content style={styles.cardContent}>
      ...
      {/* Calories */}
      <Card style={styles.card} onPress={() => router.push("/calories" as any)}>
        <Card.Content style={styles.cardContent}>
      ...
      {/* Settings */}
      <Card style={styles.card} onPress={() => router.push("/settings" as any)}>
        <Card.Content style={styles.cardContent}>
