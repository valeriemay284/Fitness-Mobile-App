...
export default function Settings() {
  ...
  const savePhysicalStats = async () => {
    ...
    try {
      ...
      const response = await fetch("http://10.40.138.223:8080/api/updatePhysicalStats", {
        method: "PUT",
  ...
  const savePersonalInfo = async () => {
    ...
    try {
      ...
      const response = await fetch("http://10.40.138.223:8080/api/updatePersonalInfo", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          id: user.id,
  ...
  const saveGoalsInfo = async () => {
    ...
    try {
      ...
      const response = await fetch("http://10.40.138.223:8080/api/updateGoals", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          id: user.id,
